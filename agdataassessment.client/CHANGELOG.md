...
- Create Angular project with ng: `ng new agdataassessment.client --defaults --skip-install --skip-git --no-standalone `.
...
- Update `app.component.ts` component to fetch and display data model information.
- Modify `app.component.spec.ts` with updated tests.
- Update `app.module.ts` to import the HttpClientModule.
- Create project file (`agdataassessment.client.esproj`).
